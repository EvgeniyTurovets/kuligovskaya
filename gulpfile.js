...
const libs = () => {
  return src(['./src/js/libs/**.js']).pipe(dest('./app/js/libs/'));
}
...
exports.default = series(clean, htmlInclude, scripts, libs, styles, resources, images, svgSprites, watchFiles);

exports.build = series(toProd, clean, htmlInclude, scripts, libs, styles, resources, images, svgSprites, htmlMinify);
